    ...
    return (
        ...
        <div className="navbar bg-base-100 shadow-sm px-8">
            ...
            <div className="navbar-end gap-2">
                {/* login */}
                <a href="#_" className="relative inline-flex items-center justify-start px-6 py-2 overflow-hidden font-medium transition-all bg-purple-500 rounded hover:bg-white group">
                ...
                {/* register */}
                <a href="#_" className="relative inline-flex items-center justify-start px-6 py-2 overflow-hidden font-medium transition-all bg-pink-700 rounded hover:bg-white group">
                    <span className="w-48 h-48 rounded rotate-[-40deg] bg-black absolute bottom-0 left-0 -translate-x-full ease-out duration-500 transition-all translate-y-full mb-9 ml-9 group-hover:ml-0 group-hover:mb-32 group-hover:translate-x-0"></span>
