...
const Banner = () => {
    return (
        ...
        <div className='flex justify-center md:flex-row flex-col items-center md:max-w-11/12 mx-auto py-12 gap-5'>

            <div className='md:w-6/12 w-10/12'>
                <h1 className="text-3xl md:text-6xl font-bold text-purple-800">Reliable Invoicing,
                    <br />
