        ...
        <div>
            ...
            <div className="hero bg-base-200">
                <div className="border-b-2 mb-4 hero-content flex-col lg:flex-row">
                    ...
                    />
                    <div>
                        <h1 className="text-4xl font-bold">🔌 1. Electricity Bill!</h1>
                        <p className="py-6">
            ...
            <div className="hero bg-base-200">
               <div className="border-b-2 mb-4 hero-content flex-col lg:flex-row-reverse">
                    ...
                    />
                    <div>
                        <h1 className="text-4xl font-bold">💧 2. Water Bill!</h1>
                        <p className="py-6">
            ...
            <div className="hero bg-base-200">
               <div className="border-b-2 mb-4 hero-content flex-col lg:flex-row">
                    ...
                    />
                    <div>
                        <h1 className="text-4xl font-bold">🔥 3. Gas Bill!</h1>
                        <p className="py-6">
            ...
            <div className="hero bg-base-200">
               <div className="border-b-2 mb-4 hero-content flex-col lg:flex-row-reverse">
                    ...
                    />
                    <div>
                        <h1 className="text-4xl font-bold">🌐 4. All-in-One Utility!</h1>
                        <p className="py-6">
